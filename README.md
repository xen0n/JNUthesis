...
该规定意味着任何其他字体均不能使用，包括等宽字体，这对排版程序代码等内容十分不利。本宏包作者及多位使用者均面临过类似的情况，事实证明江南大学物联网工程学院、理学院、数字媒体学院的字体要求没有谈判空间（文科专业尚且可以酌情使用楷体等字体标注直接引语等内容）。因此，本宏包**默认设置使等宽字体与衬线字体相同，使所有`\texttt`等命令实质上无效，以减少您提交论文时的困扰**。
